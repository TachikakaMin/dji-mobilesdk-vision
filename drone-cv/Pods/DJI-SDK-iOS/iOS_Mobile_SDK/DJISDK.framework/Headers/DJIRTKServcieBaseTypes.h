...
/**
 *  All the possible state of `DJIRTKReferenceStationSource`.  It is only supported
 *  by Phantom 4 RTK and Matrice 210 RTK V2.
 */
typedef NS_ENUM(uint8_t, DJIRTKReferenceStationSource) {
     ...
     *  "DJINetworkRTKHelper.framework" to the project by using Cocoapods
