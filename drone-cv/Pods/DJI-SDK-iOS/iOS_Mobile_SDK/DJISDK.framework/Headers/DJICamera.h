 ...
 *  camera, Mavic 2 Zoom Camera and  Mavic 2 Enterprise Camera. @return `YES` if
 ...
 *  Z30 camera, Mavic 2 Zoom Camera and Mavic 2 Enterprise Camera.
 *  
 ...
 *  camera, Mavic 2 Zoom Camera and Mavic 2 Enterprise Camera.
 *  
 ...
 *  factor is then calculated and given through this method. For Mavic 2 Zoom Camera
 *  and Mavic 2 Enterprise Camera,  the zoom factor can be calculated by invoking
 *  `getOpticalZoomFocalLengthWithCompletion` and
 ...
 *  Olympus M.Zuiko ED 14-42mm f/3.5-5.6 EZ, Z3 camera, Z30 camera, Mavic 2 Zoom
 *  Camera  and Mavic 2 Enterprise Camera.
 *  
 ...
 *  f/3.5-5.6 EZ, Z3 camera, Z30 camera, Mavic 2 Zoom Camera and Mavic 2 Enterprise
 *  camera.
 *  
 *  @param completion The execution callback with the returned execution result.
 */
 ...
 *  the actual live view resolution will be 720p. Supported only by Mavic Pro, Mavic
 *  2 Pro, Mavic 2 Zoom and Phantom 4 Pro V2.0.
 *  
 *  @param enabled The enabled value.
 *  @param error Error retrieving the value.
 *  @param completion Completion block to receive the result.
