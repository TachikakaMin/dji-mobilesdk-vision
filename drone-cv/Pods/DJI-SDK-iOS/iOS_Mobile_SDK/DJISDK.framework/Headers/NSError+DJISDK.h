...
typedef NS_ENUM(NSInteger, DJIRTKNetworkServiceError) {
    ...
    /**
     *  No logged in account or the login session has expired.
     */
    ...
    /**
     *  Please add the "DJINetworkRTKHelper.framework" to the project by using
     *  Cocoapods (https://cocoapods.org/pods/DJINetworkRTKHelper) to use the network
     *  RTK.
     */
