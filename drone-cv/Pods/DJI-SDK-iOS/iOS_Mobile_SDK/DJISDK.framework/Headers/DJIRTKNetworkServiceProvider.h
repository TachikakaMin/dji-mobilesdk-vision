 ...
 *  before connecting to DJI aircrafts. It is only supported  by Phantom 4 RTK and
 *  Matrice 210 RTK V2.
 */
 ...
 *  `DJIRTKReferenceStationSource` is `DJIRTKReferenceStationSourceNetworkRTK`.
 *  
 ...
 */
- (void)getNetworkServiceOrderPlansWithCompletion:(void(^)(DJIRTKNetworkServicePlansState *plans, NSError *error))completion;
